...
#define wmax 10      // maksymalna prewdkosc wiatru (na 'dole')
#define dt 0.1     // krok czasowy
...
int main() {
    ...
    fclose(fp);
    system("python3 ./plotter.py data/data.csv 'x' 'y(x)' 'Ruch kulki z oporem powietrza' equal");
    return 0;
}